...
type SortMode = 'attention' | 'conviction' | 'az';
...
function ThesisCard({ t }: { t: ThesisSummary }) {
  ...
  return (
    <Link
      href={`/theses/${t.id}`}
      className="text-left w-full border border-slate-800 hover:border-slate-600 bg-slate-900/60 rounded-lg p-4 transition-colors group block focus:outline-none focus-visible:border-amber-500"
    >
